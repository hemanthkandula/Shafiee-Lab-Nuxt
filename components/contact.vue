    ...
    <section>
      <div class="Container Container--maxWidth Contact-footer-container">
        ...
        <div class="Contact-footer--right">
          <div
            class="Contact-footer--right-background"
          ...
          >
            <div class="Contact-footer--right-content">
              <div>
                ...
                <a
                  class="btn btn--outline-white btn--arrowRight"
                  href="https://www.google.com/maps/place/65+Landsdowne+St,+Cambridge,+MA+02139"
                  target="_blank"
                  >Get Directions</a
                >
              </div>
...
<style scoped>
@import '../assets/contact/css/component.css';
@import '../assets/contact/css/cs-select.css';
@import '../assets/contact/css/cs-skin-boxes.css';
@import '../assets/contact/css/demo.css';
...
@media all {
  ...
  *,
  ...
  .Contact section-contact:last-of-type {
    overflow-x: hidden;
    padding: 0;
    background: #f5f5f5;
  ...
  .Contact-footer--right .Contact-footer--right-content > div {
    ...
    margin: auto;
    background: url(file:///C:/Users/heman/Downloads/PaxHeaders.X/contact/images/icons/meta/icon-location-white.svg)
      30px 38px no-repeat #da4d3c;
    background-size: 6%;
  }
