...
article:nth-of-type(-n + 2) {
  margin-bottom: calc(var(--height) * -0.3);
}
article:nth-of-type(n + 5):nth-of-type(-n + 11) {
  margin-top: calc(var(--height) * -0.3);
}
...
article:hover img,
video article:hover [class*='svg-icon'] {
