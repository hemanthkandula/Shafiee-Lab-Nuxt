      ...
      <div class="Container Footer-container">
        <div class="Container--default">
          <a
            ...
            target="_blank"
          >
            <img alt="logo" height="39" src="/logo_white.png" width="200" />
          </a>
          <div
            class="Footer-top"
            itemscope=""
          ...
          >
            <div class="Footer-contact">
              ...
              <div>
                ...
                <span>
                  <a href="tel:(617) 768 – 8315">
                    <span itemprop="telephone" contactoption="TollFree"
                      >(617) 768 – 8315</span
                    >
                  </a>
                </span>
              ...
              <div>
                ...
                <span>
                  <a
                    href="mailto:hshafiee[at]bwh.harvard.edu"
                    title="hshafiee[at]bwh.harvard.edu"
                  >
                    <span itemprop="email">hshafiee[at]bwh.harvard.edu</span>
                  </a>
                </span>
              </div>
            </div>
            <div
              ...
              itemscope=""
              itemprop="address"
              itemtype="W1    http://schema.org/PostalAddress"
            >
            ...
            <div class="Footer-social">
              <a
                ...
                target="_blank"
                title="Shafiee Laboratory | Facebook"
                class="Icon Icon--facebook"
              ></a>

              <a
                href="https://www.linkedin.com/company/brigham-and-women's-hospital"
                target="_blank"
                title="Shafiee Laboratory | Linkedin"
                class="Icon Icon--linkedin"
              ></a>

              <a
                href="https://www.youtube.com/channel/UCpVkZIs1AfIrMPpE-rDLE6g"
                target="_blank"
                title="Shafiee Laboratory | Youtube"
          ...
          <div class="Footer-information">
            <div class="Footer-information-left">
              <nav class="Footer-menu">
                <ul class="Menu">
                  ...
                  <li
                    class="Menu-item Menu-item--type-aboutUs Menu-item--object-aboutUs"
                  >
                    <nuxt-link exact to="/Publications">
                      Publications
                    </nuxt-link>
                  </li>
              ...
              <div class="Footer-copyright">
                Copyright © 2019 Shafiee Laboratory | All rights reserved
              </div>
            </div>
...
@media all {
  ...
  *,
  ...
  .Icon--youtube:after {
    background-image: url(/icons/icon-youtube-white.svg);
    z-index: 2;
    opacity: 0.35;
  }
  .Icon--youtube:before {
  ...
  .Icon--linkedin:after {
    background-image: url(/icons/icon-linkedin-white.svg);
    z-index: 2;
    opacity: 0.35;
  }
  .Icon--linkedin:before {
